...
def main():
    ...
    if selection == 1:  # Sign Up
        ...
        main()
    elif selection == 2:  # login sub-menu2
        usrname = User.login()
        if usrname:
            login = True
            ...
            while login == True:
                ...
                if selection2 == 1:  # Deposit
                    amount = input(
                        f"Enter your deposit {user.usrname} to account {account.account_num}: "
                    )
                    print("")
                    ok = True  # Error Check
                    while ok == True:
                    ...
                    amount = input(
                        f"How much do you want to withdraw {user.usrname} from account {account.account_num}: "
                    )
                    print("")
                    ok = True  # Error Check
                    while ok == True:
